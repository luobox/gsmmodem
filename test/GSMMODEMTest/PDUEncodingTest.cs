    ...
    public class PDUEncodingTest
    {
        ...
        public void PDUEncoderWithSCATest() //含短信中心号编码测试
        {
            ...
            for (int i = 0; i <3; i++)
            {
                ...
                Assert.Equal("0891683108501105F011000BA15150800576F70000C40131", pe.PDUEncoder("15050850677", "_")[0].PduCode);
            }
        ...
        [Fact]
        public void PDUDecoderofUsc2SmsTest()    //一般短信解码测试（） UCS2
        {
            //短信内容：1一个字符
        ...
        [Fact]
        public void PDUDecoderofAsciiSmsTest()    //一般短信解码测试（） Ascii 7bit
        {

            //8bit 
            //短信内容：12两个字符
            Assert.Equal("010100,8613800755500,8613510429871,20120113182623,TN:IMEI1,358688000000158,Z0010089,B16TVDUO,CID:0,EV206_B16TV_20120113_V8", pe.PDUDecoder("0891683108705505F0040D91683115409278F100042110318162322348544E3A494D4549312C3335383638383030303030303135382C5A303031303038392C423136545644554F2C4349443A302C45563230365F42313654565F32303132303131335F5638").ToString());

            //8bit 
            //短信内容：12两个字符
            Assert.Equal("010100,8613800755500,8613510429871,20120113182623,TN:IMEI1,358688000000158,Z0010089,B16TVDUO,CID:0,EV206_B16TV_20120113_V8", pe.PDUDecoder("0891683108705505F0040D91683115409278F100042110410122852348544E3A494D4549312C3335383638383030303030303135382C5A303031303038392C423136545644554F2C4349443A302C45563230365F42313654565F32303132303131335F5638").ToString());
            // 

            //短信内容：1一个字符
            Assert.Equal("010100,8613800511500,8615050850677,20110520211152,m_", pe.PDUDecoder("0891683108501105F0040D91685150800576F700001150021211252302ed08").ToString());

            //短信内容下划线测试：abit_abit 61719AFE0D8BD374 61719A1E098BD374
            Assert.Equal("010100,8613800755500,8615920026435,20110831171302,abit_abit", pe.PDUDecoder("0891683108705505F0040D91685129006234F50000118013713120230961719A1E098BD374").ToString());
            ...
            //短信内容：一条 +1
            Assert.Equal("0202B2,8613800511500,8615050850677,20110520213101,(...)))))))).@", pe.PDUDecoder("0891683108501105F0440D91685150800576F70000115002121310230F050003B2020252A9542A954AB900").ToString());
